    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden mt-6 shadow-sm sm:rounded-lg">
                <form action="{{ route('demo.update', $demo) }}" method="post" class="flex flex-col py-10 lg:px-8" enctype="multipart/form-data">
                    @method('put')
                    @csrf
                    ...
                    <x-text-input
                        ...
                        :value="@old('demo_link', $demo->demo_link)"
                        class="pl-4 placeholder:italic placeholder-gray-400 bg-white rounded-md w-full h-12 text-gray-800 shadow-xl mb-5"
                        autocomplete="off"
                    ></x-text-input>
                    <x-text-input
                        ...
                        :value="@old('thumbnail', $demo->thumbnail_path)"
                        class="pl-4 placeholder:italic placeholder-gray-400 bg-white rounded-md w-full h-12 text-gray-800 shadow-xl mb-5"
                        accept=".jpg, .png, .gif"
                    ></x-text-input>
                    <x-text-area
                        ...
                        :value="@old('caption', $demo->caption)"
